...
export default function Example() {
  ...
  useEffect(() => {
    document.title = " Detail 911 Turbo Cabrioret - Porsche By Ezar Satria P";
          ...
          <div className="h-96">
            <img
              ...
              src={
                ...
                "/assets/img_product/detailturbocabrioret.png"
              }
              alt=""
            />
          </div>
        ...
        <div className="my-8 grid grid-cols-2 justify-between">
          ...
          <div className="">
            <img
              ...
              src={process.env.PUBLIC_URL + "/assets/img_product/cabri.svg"}
              alt=""
            />
          </div>
        </div>
