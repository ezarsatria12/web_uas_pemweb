  ...
  return (
    <div className="bg-white max-w-screen-2xl">
        ...
        <div className="relative h-100 w-full flex flex-col justify-center gap-y-2 px-10 my-10 lg:px-20 snap-center">
          ...
          <div className="h-96">
            <img
              ...
              src={
                process.env.PUBLIC_URL + "/assets/img_product/detailgt3rs.png"
              }
              alt=""
            />
          </div>
      ...
      <div className="relative flex items-end  h-screen overflow-hidden">
        <div class="relative z-30 p-5 text-5xl font-semibold text-white mx-20 my-48">
          <h1>Perfection is never the start.</h1>
        </div>
        <video
          autoPlay
          muted
        ...
        >
          <source
            src={process.env.PUBLIC_URL + "/assets/video/porsche-video.mp4"}
            type="video/mp4"
          />
        </video>
      </div>
      <div className="relative flex items-end  h-screen overflow-hidden">
        ...
        >
          <source
            src={process.env.PUBLIC_URL + "/assets/video/porsche-video2.mp4"}
            type="video/mp4"
          />
        </video>
      </div>
      <div className="relative flex flex-col mx-20 py-16 gap-2">
        <h1 className="font-porsche font-semibold text-4xl tracking-wide">
          The 911 GT3 RS.
        </h1>
        <p className="font-porsche text-base tracking-wide w-2/3">
          Athletes know: Top performance requires more than perfect conditions
          and luck. Relentless training to become stronger and faster.
          Questioning everything, especially yourself. Learning from every
          mistake. Because the biggest challenge is to remain unbeatable. With
          this attitude, Porsche keeps pushing the boundaries of what is
          possible. Experience the new 911 GT3 RS in top form — with increased
      ...
      <div className="relative flex items-end  h-screen overflow-hidden">
        ...
        >
          <source
            src={process.env.PUBLIC_URL + "/assets/video/porsche-video3.mp4"}
            type="video/mp4"
          />
        </video>
      </div>
      <div className="relative flex items-end  h-screen overflow-hidden">
        <div class="relative z-30 p-5 text-5xl font-semibold text-white mx-20 my-48">
          <h1>Drag Reduction System (DRS) — rear wing.</h1>
        </div>
        <video
          autoPlay
          muted
        ...
        >
          <source
            src={process.env.PUBLIC_URL + "/assets/video/porsche-video4.mp4"}
            type="video/mp4"
          />
        </video>
      </div>
        ...
        <div className="my-8 grid grid-cols-2 justify-between">
          ...
          <div className="">
            <img
              ...
              src={process.env.PUBLIC_URL + "/assets/img_product/gt3rs.svg"}
              alt=""
            />
          </div>
        </div>
